...
- Unblocked：`4`
- Blocked：`6`
- Next action：`singleton-concept-base` | 扩展单节点概念 Base | score `61` | blocked `False`
- Priority queue:
  - `singleton-concept-base` | 扩展单节点概念 Base | score `61` | impact `53` | blocked `False`
  - `overloaded-concept-and` | 拆分过载概念 And | score `58` | impact `50` | blocked `False`
  - `overloaded-concept-the` | 拆分过载概念 The | score `58` | impact `50` | blocked `False`
  - `overloaded-concept-url` | 拆分过载概念 Url | score `58` | impact `50` | blocked `False`
  - `bridge-concept-abstract` | 观察桥接概念 Abstract | score `28` | impact `32` | blocked `True`
  - `bridge-concept-agents` | 观察桥接概念 Agents | score `28` | impact `32` | blocked `True`

## Ready Now
- 当前没有 ready action。

## Need Triage
- [medium] 拆分过载概念 Url | primary `wiki/concepts/url.md` | band `review-first` | next 把过载概念拆成更窄的概念页或子主题。 | command `PYTHONPATH=src python3 -m aiwiki.cli --root . review-action overloaded-concept-url --status accepted --note "Accepted for manual repair."`
- [medium] 扩展单节点概念 Base | primary `wiki/concepts/base.md` | band `review-first` | next 扩展单节点概念的相关来源或相关概念。 | command `PYTHONPATH=src python3 -m aiwiki.cli --root . review-action singleton-concept-base --status accepted --note "Accepted for manual repair."`
- [medium] 拆分过载概念 And | primary `wiki/concepts/and.md` | band `review-first` | next 把过载概念拆成更窄的概念页或子主题。 | command `PYTHONPATH=src python3 -m aiwiki.cli --root . review-action overloaded-concept-and --status accepted --note "Accepted for manual repair."`
- [medium] 拆分过载概念 The | primary `wiki/concepts/the.md` | band `review-first` | next 把过载概念拆成更窄的概念页或子主题。 | command `PYTHONPATH=src python3 -m aiwiki.cli --root . review-action overloaded-concept-the --status accepted --note "Accepted for manual repair."`
...
- [low] 观察桥接概念 Url | primary `wiki/concepts/url.md` | band `review-first` | next 确认桥接概念仍然必要，并记录观察结论。 | command `PYTHONPATH=src python3 -m aiwiki.cli --root . review-action bridge-concept-url --status accepted --note "Accepted for manual repair."`
...
## Execution Proposals
- [medium] 扩展单节点概念 Base | status `待处理` | kind `expand-concept` | risk `medium` | score `61` | targets `wiki/concepts/base.md` | command `PYTHONPATH=src python3 -m aiwiki.cli --root . review-action singleton-concept-base --status accepted --note "Accepted for manual repair."`
  - strategy: 扩展单节点概念的来源覆盖或相关概念边界。 同时检查 benchmark、experiment、tradeoff 和 regression risk 是否需要同步更新。
  - bundle: `output/control/execution-bundles/singleton-concept-base.json`
  - rollback: 回滚时需要人工恢复目标页，然后重跑 compile。
  - edit: 补更多来源或相关概念反链。
  - edit: 重写摘要时强调当前证据仍然有限。
  - edit: 如果概念过窄，考虑降级为 source-specific note。
  - patch `wiki/concepts/base.md` | role `概念页` | mode `update` | sections `Summary, Related Sources, Related Concepts`
  - patch `wiki/indexes/concept-quality.md` | role `索引页` | mode `review` | sections `Rewrite Priority, Open Questions`
- [medium] 拆分过载概念 And | status `待处理` | kind `split-concept` | risk `high` | score `58` | targets `wiki/concepts/and.md` | command `PYTHONPATH=src python3 -m aiwiki.cli --root . review-action overloaded-concept-and --status accepted --note "Accepted for manual repair."`
...
- [medium] 拆分过载概念 The | status `待处理` | kind `split-concept` | risk `high` | score `58` | targets `wiki/concepts/the.md` | command `PYTHONPATH=src python3 -m aiwiki.cli --root . review-action overloaded-concept-the --status accepted --note "Accepted for manual repair."`
  - strategy: 拆分过载概念，明确子概念边界和来源分流。 同时检查 benchmark、experiment、tradeoff 和 regression risk 是否需要同步更新。
  ...
  - patch `wiki/indexes/concept-quality.md` | role `索引页` | mode `review` | sections `Merge Candidates, Rewrite Priority`
  - patch `wiki/indexes/rewrite-proposals.md` | role `索引页` | mode `review` | sections `Merge Candidates, Rewrite Priority`
- [medium] 拆分过载概念 Url | status `待处理` | kind `split-concept` | risk `high` | score `58` | targets `wiki/concepts/url.md` | command `PYTHONPATH=src python3 -m aiwiki.cli --root . review-action overloaded-concept-url --status accepted --note "Accepted for manual repair."`
  - strategy: 拆分过载概念，明确子概念边界和来源分流。 同时检查 benchmark、experiment、tradeoff 和 regression risk 是否需要同步更新。
  ...
  - edit: 把 source pages 重新分流到更具体的概念页。
  - edit: 在原概念页保留拆分说明和跳转链接。
  - patch `wiki/concepts/url.md` | role `概念页` | mode `rewrite` | sections `Summary, Related Sources, Related Concepts`
  - patch `wiki/indexes/concept-quality.md` | role `索引页` | mode `review` | sections `Merge Candidates, Rewrite Priority`
  - patch `wiki/indexes/rewrite-proposals.md` | role `索引页` | mode `review` | sections `Merge Candidates, Rewrite Priority`
- [low] 观察桥接概念 Abstract | status `待处理` | kind `monitor-bridge` | risk `low` | score `28` | targets `wiki/concepts/abstract.md` | command `PYTHONPATH=src python3 -m aiwiki.cli --root . review-action bridge-concept-abstract --status accepted --note "Accepted for manual repair."`
  ...
  - rollback: 回滚时需要人工恢复目标页，然后重跑 compile。
  - depends_on: `overloaded-concept-url, overloaded-concept-and, overloaded-concept-the`
...
- [low] 观察桥接概念 Agents | status `待处理` | kind `monitor-bridge` | risk `low` | score `28` | targets `wiki/concepts/agents.md` | command `PYTHONPATH=src python3 -m aiwiki.cli --root . review-action bridge-concept-agents --status accepted --note "Accepted for manual repair."`
  - strategy: 记录桥接概念仍然必要的原因，避免误删跨簇连接。 同时检查 benchmark、experiment、tradeoff 和 regression risk 是否需要同步更新。
  ...
  - patch `wiki/indexes/graph-health.md` | role `索引页` | mode `review` | sections `Bridge Concepts, Repair Signals`
- [low] 观察桥接概念 And | status `待处理` | kind `monitor-bridge` | risk `low` | score `28` | targets `wiki/concepts/and.md` | command `PYTHONPATH=src python3 -m aiwiki.cli --root . review-action bridge-concept-and --status accepted --note "Accepted for manual repair."`
  - strategy: 记录桥接概念仍然必要的原因，避免误删跨簇连接。 同时检查 benchmark、experiment、tradeoff 和 regression risk 是否需要同步更新。
  ...
  - patch `wiki/indexes/graph-health.md` | role `索引页` | mode `review` | sections `Bridge Concepts, Repair Signals`
- [low] 观察桥接概念 Protocol | status `待处理` | kind `monitor-bridge` | risk `low` | score `28` | targets `wiki/concepts/protocol.md` | command `PYTHONPATH=src python3 -m aiwiki.cli --root . review-action bridge-concept-protocol --status accepted --note "Accepted for manual repair."`
  - strategy: 记录桥接概念仍然必要的原因，避免误删跨簇连接。 同时检查 benchmark、experiment、tradeoff 和 regression risk 是否需要同步更新。
  ...
  - patch `wiki/indexes/graph-health.md` | role `索引页` | mode `review` | sections `Bridge Concepts, Repair Signals`
- [low] 观察桥接概念 The | status `待处理` | kind `monitor-bridge` | risk `low` | score `28` | targets `wiki/concepts/the.md` | command `PYTHONPATH=src python3 -m aiwiki.cli --root . review-action bridge-concept-the --status accepted --note "Accepted for manual repair."`
  - strategy: 记录桥接概念仍然必要的原因，避免误删跨簇连接。 同时检查 benchmark、experiment、tradeoff 和 regression risk 是否需要同步更新。
  ...
  - patch `wiki/indexes/graph-health.md` | role `索引页` | mode `review` | sections `Bridge Concepts, Repair Signals`
- [low] 观察桥接概念 Url | status `待处理` | kind `monitor-bridge` | risk `low` | score `28` | targets `wiki/concepts/url.md` | command `PYTHONPATH=src python3 -m aiwiki.cli --root . review-action bridge-concept-url --status accepted --note "Accepted for manual repair."`
  - strategy: 记录桥接概念仍然必要的原因，避免误删跨簇连接。 同时检查 benchmark、experiment、tradeoff 和 regression risk 是否需要同步更新。
  ...
  - edit: 确认相关概念链接仍然成立。
  - edit: 如果桥接已经失效，再把动作转成 merge 或 split。 
  - patch `wiki/concepts/url.md` | role `概念页` | mode `review` | sections `Summary, Related Concepts, Related Sources`
  - patch `wiki/indexes/graph-health.md` | role `索引页` | mode `review` | sections `Bridge Concepts, Repair Signals`

## Page-Level Patch Plans
### `singleton-concept-base` · 扩展单节点概念 Base
- Summary: 扩展单节点概念的来源覆盖或相关概念边界。 同时检查 benchmark、experiment、tradeoff 和 regression risk 是否需要同步更新。
- Risk: `medium` | Protocol: `research`
- `wiki/concepts/base.md` | role `概念页` | mode `update` | sections `Summary, Related Sources, Related Concepts` | exists `True`
  - 补来源覆盖、显式有限证据，并更新相关概念边界。 同步检查 benchmark、experiment、tradeoff 和 regression risk 是否要一起更新。
  - command: `PYTHONPATH=src python3 -m aiwiki.cli --root . review-action singleton-concept-base --status accepted --note "Accepted for manual repair."`
- `wiki/indexes/concept-quality.md` | role `索引页` | mode `review` | sections `Rewrite Priority, Open Questions` | exists `True`
...
- `wiki/indexes/rewrite-proposals.md` | role `索引页` | mode `review` | sections `Merge Candidates, Rewrite Priority` | exists `True`
  - 在概念质量层复核拆分理由和后续子概念候选。 同步检查 benchmark、experiment、tradeoff 和 regression risk 是否要一起更新。
  - command: `PYTHONPATH=src python3 -m aiwiki.cli --root . review-action overloaded-concept-the --status accepted --note "Accepted for manual repair."`
### `overloaded-concept-url` · 拆分过载概念 Url
- Summary: 拆分过载概念，明确子概念边界和来源分流。 同时检查 benchmark、experiment、tradeoff 和 regression risk 是否需要同步更新。
- Risk: `high` | Protocol: `research`
- `wiki/concepts/url.md` | role `概念页` | mode `rewrite` | sections `Summary, Related Sources, Related Concepts` | exists `True`
  - 缩窄概念边界、保留拆分说明，并给出后续子概念方向。 同步检查 benchmark、experiment、tradeoff 和 regression risk 是否要一起更新。
  - command: `PYTHONPATH=src python3 -m aiwiki.cli --root . review-action overloaded-concept-url --status accepted --note "Accepted for manual repair."`
- `wiki/indexes/concept-quality.md` | role `索引页` | mode `review` | sections `Merge Candidates, Rewrite Priority` | exists `True`
  - 在概念质量层复核拆分理由和后续子概念候选。 同步检查 benchmark、experiment、tradeoff 和 regression risk 是否要一起更新。
  - command: `PYTHONPATH=src python3 -m aiwiki.cli --root . review-action overloaded-concept-url --status accepted --note "Accepted for manual repair."`
- `wiki/indexes/rewrite-proposals.md` | role `索引页` | mode `review` | sections `Merge Candidates, Rewrite Priority` | exists `True`
...
- [待处理] 观察桥接概念 Concepts | inactive_since `2026-04-15T01:45:54+00:00` | next 信号已消失；确认是否要作为已解决归档。 | command `PYTHONPATH=src python3 -m aiwiki.cli --root . review-action bridge-concept-concepts --status resolved --note "Signal disappeared after compile."`
