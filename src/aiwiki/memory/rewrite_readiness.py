"""Concept-rewrite readiness helpers (no execution-domain deps).

Extracted from ``execution.repair_plan`` so memory surfaces can check
apply-ready without importing the repair-plan owner.
"""
