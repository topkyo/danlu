...
| Product Shell Jest | **180** passed | `bash scripts/verify.sh product-shell-static` |
...
| Product Shell | 12% | 9.3 | yes | Jest **180** + sync `run-ask` 单飞 + Today-first |
...
| 4 | Product Shell | Jest **180** — `bash scripts/verify.sh product-shell-static` |
