...
AIWIKI_NIGHTLY_AUTO_APPLY_LIGHT=${AIWIKI_NIGHTLY_AUTO_APPLY_LIGHT:-${AUTO_APPLY_LIGHT:-1}}
AIWIKI_NIGHTLY_AUTO_ADOPT_L1=${AIWIKI_NIGHTLY_AUTO_ADOPT_L1:-${AUTO_ADOPT_L1:-1}}
AIWIKI_NIGHTLY_AUTO_ADOPT_L2=${AIWIKI_NIGHTLY_AUTO_ADOPT_L2:-${AUTO_ADOPT_L2:-1}}
AIWIKI_NIGHTLY_AUTO_ADOPT_L3=${AIWIKI_NIGHTLY_AUTO_ADOPT_L3:-${AUTO_ADOPT_L3:-1}}
AIWIKI_NIGHTLY_AUTO_ADOPT_JUDGMENTS=${AIWIKI_NIGHTLY_AUTO_ADOPT_JUDGMENTS:-${AUTO_ADOPT_JUDGMENTS:-1}}
AIWIKI_NIGHTLY_AUTO_APPLY_HEAVY_SEMANTIC=${AIWIKI_NIGHTLY_AUTO_APPLY_HEAVY_SEMANTIC:-1}
...
ensure_env_key "$NIGHTLY_ENV_PATH" "AIWIKI_NIGHTLY_AUTO_APPLY_LIGHT" "${AIWIKI_NIGHTLY_AUTO_APPLY_LIGHT:-${AUTO_APPLY_LIGHT:-1}}"
ensure_env_key "$NIGHTLY_ENV_PATH" "AIWIKI_NIGHTLY_AUTO_ADOPT_L1" "${AIWIKI_NIGHTLY_AUTO_ADOPT_L1:-${AUTO_ADOPT_L1:-1}}"
ensure_env_key "$NIGHTLY_ENV_PATH" "AIWIKI_NIGHTLY_AUTO_ADOPT_L2" "${AIWIKI_NIGHTLY_AUTO_ADOPT_L2:-${AUTO_ADOPT_L2:-1}}"
ensure_env_key "$NIGHTLY_ENV_PATH" "AIWIKI_NIGHTLY_AUTO_ADOPT_L3" "${AIWIKI_NIGHTLY_AUTO_ADOPT_L3:-${AUTO_ADOPT_L3:-1}}"
ensure_env_key "$NIGHTLY_ENV_PATH" "AIWIKI_NIGHTLY_AUTO_ADOPT_JUDGMENTS" "${AIWIKI_NIGHTLY_AUTO_ADOPT_JUDGMENTS:-${AUTO_ADOPT_JUDGMENTS:-1}}"
ensure_env_key "$NIGHTLY_ENV_PATH" "AIWIKI_NIGHTLY_AUTO_APPLY_HEAVY_SEMANTIC" "${AIWIKI_NIGHTLY_AUTO_APPLY_HEAVY_SEMANTIC:-1}"
