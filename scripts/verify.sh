...
Targets:
  ...
  llm-integration       Run LLM integration tests (88 tests, mock backends).
  ...
  all                   Run scripts + product-shell-static + cli-smoke + smoke + python-static + unit + acceptance (25) + llm-integration (88) + coverage report. Default.
USAGE
}
