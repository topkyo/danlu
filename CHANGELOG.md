...
- verify 现行口径：acceptance **24** + llm-integration **85** + unit **151** + Jest **203**（coverage informational **69%**；历史 16/17/18/25、42/65/76/78/79、72/81/143、174/189/206 等为沿革快照）。
