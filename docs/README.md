...
| [Furnace Product Shell Plugin](<./Furnace Product Shell Plugin.md>) | Obsidian 插件 surface 契约 |
| [Furnace Product Shell Runtime Plan](<./Furnace Product Shell Runtime Plan.md>) | Shell-runtime 契约计划 |
| [product_shell_ui_v3_review](<./product_shell_ui_v3_review.md>) | EP-024 UI 重构评估史料 |
