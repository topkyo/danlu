...
| Tests | acceptance **25** + llm-integration **84** + unit **176** + Jest **203**（2026-08-06 入口面清理后实测；历史快照曾含 24/85/166、24/85/160、24/85/154、24/85/143 等） | `bash scripts/verify.sh all` |
