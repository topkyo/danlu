...
| Tests | acceptance **24** + llm-integration **85** + unit **147** + Jest **203**（2026-08-05 优先债收口后实测；历史快照曾含 24/85/143、24/85/81、24/85/72 等） | `bash scripts/verify.sh all` |
...
bash scripts/verify.sh all   # 推送/发布前（含 unit 147 + coverage informational）
```
...
- 2026-08-05：优先债收口（不含 Commercial 三阻断）— §1 对齐 **187** py / **~43.8k** / unit **147** / 工程实测 **8.2**；coverage 快照 **69%**；`docs_consistency` 钉 Post-Cleanup unit 147。
