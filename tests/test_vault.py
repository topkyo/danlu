...
class VaultBootstrapTests(unittest.TestCase):
    ...
    def test_bootstrap_new_vault_creates_launcher_plugin_and_shell_summary(self) -> None:
        ...
        self.assertEqual(graph_config["search"], 'path:"output/reports" OR path:"raw/inbox"')
        self.assertTrue(graph_config["hideUnresolved"])
        ...
        self.assertIn('content: "原料 raw";', snippet)
        self.assertIn('content: "收件箱 inbox";', snippet)
        self.assertIn('.nav-folder[data-path="raw/assets"],', snippet)
