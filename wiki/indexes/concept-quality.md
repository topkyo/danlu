...
- 最近编译时间：`2026-04-16T14:24:31+00:00`
- 弱概念页：`30`
- 稳定概念页：`0`
- 占位概念页：`0`
- 合并候选：`12`
...
- 证据缺口：`44`
- 平均质量分：`78.2`
- Quality bands： strong `6` / stable `22` / watch `2` / fragile `0`
...
## Hard Concepts
- [Protocol](../concepts/protocol.md) | hardness `hard` | confidence `medium` | sources `4` | quality `84`
- [Agents](../concepts/agents.md) | hardness `hard` | confidence `medium` | sources `3` | quality `91`
- [Memory](../concepts/memory.md) | hardness `medium` | confidence `medium` | sources `5` | quality `87`
- [Judgment](../concepts/judgment.md) | hardness `medium` | confidence `medium` | sources `3` | quality `91`
- [Abstract](../concepts/abstract.md) | hardness `medium` | confidence `medium` | sources `3` | quality `87`

## Rewrite Now
- [And](../concepts/and.md) | hardness `soft` | issues `soft-hardness, conflicting-source-signals, evidence-gap` | sources `8` | related `6` | quality `62` | band `watch`
  - metrics: coverage `100` / consistency `65` / evidence `2` / recency `85`
- [The](../concepts/the.md) | hardness `soft` | issues `soft-hardness, conflicting-source-signals, evidence-gap` | sources `12` | related `6` | quality `62` | band `watch`
  - metrics: coverage `100` / consistency `65` / evidence `0` / recency `85`
- [A2a](../concepts/a2a.md) | hardness `soft` | issues `soft-hardness, single-source, evidence-gap, merge-boundary` | sources `1` | related `4` | quality `76` | band `stable`
  - metrics: coverage `35` / consistency `100` / evidence `86` / recency `85`
- [A2a Key Concepts](../concepts/a2a-key-concepts.md) | hardness `soft` | issues `soft-hardness, single-source, evidence-gap, merge-boundary` | sources `1` | related `4` | quality `76` | band `stable`
  - metrics: coverage `35` / consistency `100` / evidence `86` / recency `85`
- [Adk](../concepts/adk.md) | hardness `soft` | issues `soft-hardness, single-source, evidence-gap, merge-boundary` | sources `1` | related `4` | quality `76` | band `stable`
  - metrics: coverage `35` / consistency `100` / evidence `86` / recency `85`
- [Agentic](../concepts/agentic.md) | hardness `soft` | issues `soft-hardness, single-source, evidence-gap, merge-boundary` | sources `1` | related `4` | quality `76` | band `stable`
  - metrics: coverage `35` / consistency `100` / evidence `86` / recency `85`
- [Anthropic](../concepts/anthropic.md) | hardness `soft` | issues `soft-hardness, single-source, evidence-gap, merge-boundary` | sources `1` | related `2` | quality `76` | band `stable`
  - metrics: coverage `35` / consistency `100` / evidence `86` / recency `85`
- [Anthropic Tool Use](../concepts/anthropic-tool-use.md) | hardness `soft` | issues `soft-hardness, single-source, evidence-gap, merge-boundary` | sources `1` | related `2` | quality `76` | band `stable`
  - metrics: coverage `35` / consistency `100` / evidence `86` / recency `85`
- [Autogen Multi Agent](../concepts/autogen-multi-agent.md) | hardness `soft` | issues `soft-hardness, single-source, evidence-gap, merge-boundary` | sources `1` | related `4` | quality `76` | band `stable`
  - metrics: coverage `35` / consistency `100` / evidence `86` / recency `85`
- [Google Adk Agents](../concepts/google-adk-agents.md) | hardness `soft` | issues `soft-hardness, single-source, evidence-gap, merge-boundary` | sources `1` | related `4` | quality `76` | band `stable`
  - metrics: coverage `35` / consistency `100` / evidence `86` / recency `85`
- [Langgraph](../concepts/langgraph.md) | hardness `soft` | issues `soft-hardness, single-source, evidence-gap, merge-boundary` | sources `1` | related `4` | quality `76` | band `stable`
  - metrics: coverage `35` / consistency `100` / evidence `86` / recency `85`
- [Langgraph Agentic Concepts](../concepts/langgraph-agentic-concepts.md) | hardness `soft` | issues `soft-hardness, single-source, evidence-gap, merge-boundary` | sources `1` | related `4` | quality `76` | band `stable`
  - metrics: coverage `35` / consistency `100` / evidence `86` / recency `85`

## Quality Distribution
- Strong / Stable / Watch / Fragile： `6` / `22` / `2` / `0`

## Rewrite Priority
- [And](../concepts/and.md) | priority `high` | score `6` | quality `62` | band `watch` | issues `soft-hardness, conflicting-source-signals, evidence-gap`
  - strategy: 并列呈现冲突来源，明确分歧和适用边界。 保留证据缺口和不确定性，避免过强结论。
- [The](../concepts/the.md) | priority `high` | score `6` | quality `62` | band `watch` | issues `soft-hardness, conflicting-source-signals, evidence-gap`
  - strategy: 并列呈现冲突来源，明确分歧和适用边界。 保留证据缺口和不确定性，避免过强结论。
- [A2a](../concepts/a2a.md) | priority `high` | score `6` | quality `76` | band `stable` | issues `soft-hardness, single-source, evidence-gap, merge-boundary`
  - strategy: 保留证据缺口和不确定性，避免过强结论。 保持保守措辞，并指出还缺哪些来源。 检查是否需要合并或拆分概念边界。
- [A2a Key Concepts](../concepts/a2a-key-concepts.md) | priority `high` | score `6` | quality `76` | band `stable` | issues `soft-hardness, single-source, evidence-gap, merge-boundary`
  - strategy: 保留证据缺口和不确定性，避免过强结论。 保持保守措辞，并指出还缺哪些来源。 检查是否需要合并或拆分概念边界。
- [Adk](../concepts/adk.md) | priority `high` | score `6` | quality `76` | band `stable` | issues `soft-hardness, single-source, evidence-gap, merge-boundary`
  - strategy: 保留证据缺口和不确定性，避免过强结论。 保持保守措辞，并指出还缺哪些来源。 检查是否需要合并或拆分概念边界。
- [Agentic](../concepts/agentic.md) | priority `high` | score `6` | quality `76` | band `stable` | issues `soft-hardness, single-source, evidence-gap, merge-boundary`
  - strategy: 保留证据缺口和不确定性，避免过强结论。 保持保守措辞，并指出还缺哪些来源。 检查是否需要合并或拆分概念边界。
- [Anthropic](../concepts/anthropic.md) | priority `high` | score `6` | quality `76` | band `stable` | issues `soft-hardness, single-source, evidence-gap, merge-boundary`
  - strategy: 保留证据缺口和不确定性，避免过强结论。 保持保守措辞，并指出还缺哪些来源。 检查是否需要合并或拆分概念边界。
- [Anthropic Tool Use](../concepts/anthropic-tool-use.md) | priority `high` | score `6` | quality `76` | band `stable` | issues `soft-hardness, single-source, evidence-gap, merge-boundary`
  - strategy: 保留证据缺口和不确定性，避免过强结论。 保持保守措辞，并指出还缺哪些来源。 检查是否需要合并或拆分概念边界。
- [Autogen Multi Agent](../concepts/autogen-multi-agent.md) | priority `high` | score `6` | quality `76` | band `stable` | issues `soft-hardness, single-source, evidence-gap, merge-boundary`
  - strategy: 保留证据缺口和不确定性，避免过强结论。 保持保守措辞，并指出还缺哪些来源。 检查是否需要合并或拆分概念边界。
- [Google Adk Agents](../concepts/google-adk-agents.md) | priority `high` | score `6` | quality `76` | band `stable` | issues `soft-hardness, single-source, evidence-gap, merge-boundary`
  - strategy: 保留证据缺口和不确定性，避免过强结论。 保持保守措辞，并指出还缺哪些来源。 检查是否需要合并或拆分概念边界。
