...
- `wiki/concepts/agents.md` | role `概念页` | mode `review` | exists `True` | sections `Summary, Related Concepts, Related Sources`
...
- Affected paths: `wiki/concepts/agents.md`
...
- [Execution Bundle](../../output/control/execution-bundles/bridge-concept-agents.json)
