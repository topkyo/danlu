...
归档文档只作为历史和决策脉络参考，不作为当前执行事实源。当前 SoT 见 [docs/README.md](<../README.md>)、`PROGRESS.md`；阶段性清理/商业计划见 [Furnace Commercial Grade Cleanup Plan 2026-07](<../Furnace Commercial Grade Cleanup Plan 2026-07.md>)。历史 harness contract 路径（如 `.codex/contracts/active.md`）仅作史料指针，不保证仍存在于本仓库。
