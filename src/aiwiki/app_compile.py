...
def _compile_content_phase(context: _CompileContext) -> None:
    from .compile.content_step import compile_content_phase

    compile_content_phase(context)
...
def _compile_runtime_phase(context: _CompileContext) -> None:
    from .compile.runtime_step import compile_runtime_phase

    compile_runtime_phase(context)
...
def _compile_output_phase(context: _CompileContext) -> None:
    from .compile.output_step import compile_output_phase

    compile_output_phase(context)
