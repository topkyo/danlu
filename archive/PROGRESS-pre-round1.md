# 炼丹炉 Progress Archive — pre-Round 1 / pre-P4 世代

> 本文件由 `PROGRESS.md` 在 2026-04-30 D-2 archive sweep 中切出。
> 内容覆盖：M0-M9 / M-PS / M-UX / M6 / P0 (M8.1) / P1 (M8.2) / P3 (M8.3) / M7 系列 / 9-Standard Closure 世代 / 旧 EP 闭环。
> 不可作为当前执行事实源；当前 active SoT 见 `PROGRESS.md` + `docs/Furnace Next Direction Post-P4.md`。
> git 历史仍是不可抹除审计源。
