...
- verify 现行口径：acceptance **24** + llm-integration **85** + unit **160** + Jest **203**（coverage informational **69%**；历史 16/17/18/25、42/65/76/78/79、72/81/143、153、154、174/189/206 等为沿革快照）。
...
- `verify.sh all`（release 用）不再跑 pytest unit / coverage gate；现行为 7 步（scripts + product-shell-static + cli-smoke + smoke + python-static + acceptance + llm-integration，见 Unreleased 现行口径 **24** / **85** / **81** / **203**）。
