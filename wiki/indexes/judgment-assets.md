...
- 资产完整（>= 3/4）：`10`
- 治理焦点：`2`
- 生命周期 formed / active / under-review / revised / retired：`0` / `6` / `2` / `2` / `0`
- 缺反证：`0`
- 缺失效条件：`0`
- 缺下一信号：`0`
- 缺复审历史：`0`
- 缺 Counter Evidence metadata：`0`
...
## 当前治理焦点
- [Agent Governance Decision](../../wiki/decisions/decision-20260415-015034-agent-governance-decision.md) | 状态 `待复审` | 协议 `research` | 置信度 `high` | 审阅时间 `2026-04-16T02:09:52+00:00` | 复审截止 `2026-04-18T02:09:52+00:00` | 资产 `4/4` | 复审历史 `2`
- [Agent Governance Judgment](../../wiki/judgments/judgment-20260415-015034-agent-governance-judgment.md) | 状态 `持续观察` | 协议 `research` | 置信度 `medium` | 审阅时间 `2026-04-16T02:09:53+00:00` | 复审截止 `2026-04-23T02:09:53+00:00` | 资产 `4/4` | 复审历史 `3`
...
## 缺 Structured Counter Evidence Metadata
- 当前所有判断资产都携带 `counter_evidence` frontmatter 字段。

## 缺 Invalidation
- 当前所有判断资产都包含显式 invalidation 条件。

## 缺 Structured Invalidation Metadata
- 当前所有判断资产都携带 `invalidation_rule` frontmatter 字段。

## 缺 Next Signals
- 当前所有判断资产都包含下一次观察信号。

## 缺 Structured Next Signals Metadata
- 当前所有判断资产都携带 `next_signals` frontmatter 字段。
