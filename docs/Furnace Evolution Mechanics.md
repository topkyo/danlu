...
| `aiwiki review proposal <proposal-id> --status accepted\|rejected` | 当前：人工 accept/reject L3 proposal；只更新 proposal state/page，不写目标文件，不生成 apply receipt | `output/_proposals/prompt\|policy/` + `.aiwiki/state/l3-proposals.json` |
