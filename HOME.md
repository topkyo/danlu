...
- 想专门看 safe apply、proposal、patch-step、execution bundle 和 execution receipt：看 [[wiki/indexes/execution-center|执行中心]]，真正的本地执行面板在 `output/control/execution-center.html`；真实 apply 会消费 bundle，不会裸执行
