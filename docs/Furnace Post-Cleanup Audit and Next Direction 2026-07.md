...
| Tests | acceptance **25** + llm-integration **84** + unit **176** + Jest **204**（2026-08-07 入口面清理 follow-up 实测；历史快照曾含 24/85/166、24/85/160、24/85/154、24/85/143 等） | `bash scripts/verify.sh all` |
