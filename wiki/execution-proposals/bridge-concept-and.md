...
last_compiled_at: "2026-04-21T01:45:55+00:00"
---

# 观察桥接概念 And

## Overview
- Action id: `bridge-concept-and`
- Status: `待处理`
- Kind: `monitor-bridge`
- Risk: `low`
- Protocol: `research`
...
- `wiki/concepts/and.md` | role `概念页` | mode `review` | exists `True` | sections `Summary, Related Concepts, Related Sources`
...
## Commands
- Suggested apply: `PYTHONPATH=src python3 -m aiwiki.cli --root . apply-action bridge-concept-and --bundle output/control/execution-bundles/bridge-concept-and.json`
- Suggested next step: `PYTHONPATH=src python3 -m aiwiki.cli --root . review-action bridge-concept-and --status accepted --note "Accepted for manual repair."`
...
- [Execution Bundle](../../output/control/execution-bundles/bridge-concept-and.json)
