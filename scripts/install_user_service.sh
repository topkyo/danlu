...
AIWIKI_NIGHTLY_AUTO_APPLY_LIGHT=1
AIWIKI_NIGHTLY_AUTO_ADOPT_L1=1
AIWIKI_NIGHTLY_AUTO_ADOPT_L2=1
AIWIKI_NIGHTLY_AUTO_ADOPT_L3=1
AIWIKI_NIGHTLY_AUTO_ADOPT_JUDGMENTS=1
AIWIKI_CODEX_COMMAND=codex
AIWIKI_CLAUDE_COMMAND=claude
EOF
fi
...
ensure_env_key "$NIGHTLY_ENV_PATH" "AIWIKI_NIGHTLY_AUTO_APPLY_LIGHT" "1"
ensure_env_key "$NIGHTLY_ENV_PATH" "AIWIKI_NIGHTLY_AUTO_ADOPT_L1" "1"
ensure_env_key "$NIGHTLY_ENV_PATH" "AIWIKI_NIGHTLY_AUTO_ADOPT_L2" "1"
ensure_env_key "$NIGHTLY_ENV_PATH" "AIWIKI_NIGHTLY_AUTO_ADOPT_L3" "1"
ensure_env_key "$NIGHTLY_ENV_PATH" "AIWIKI_NIGHTLY_AUTO_ADOPT_JUDGMENTS" "1"
