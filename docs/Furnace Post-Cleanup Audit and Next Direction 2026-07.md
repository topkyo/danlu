...
| Tests | acceptance **24** + llm-integration **85** + unit **81** + Jest **203**（2026-08-05 实测；历史快照曾含 24/85/72/203、24/79/206 等） | `bash scripts/verify.sh all` |
...
bash scripts/verify.sh all   # 推送/发布前（含 unit 81 + coverage informational）
```
