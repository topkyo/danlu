...
# legacy no-op: runner/auto_adopt.py deleted; nightly is compile+lint only
...
echo "Note: nightly is deterministic compile+lint only; AIWIKI_NIGHTLY_AUTO_* / AUTO_* flags are legacy no-ops."
