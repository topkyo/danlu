    ...
    return (
        "\n".join(
            [
                ...
                './scripts/aiwiki-launcher.sh advanced run-ask-submit "今天最重要的变化是什么？" --format report',
                ...
                "3. 提问也有两个入口：Obsidian Product Shell 的 `Ask`，以及 `./scripts/aiwiki-launcher.sh advanced run-ask-submit ... --format report`；默认生成 `output/reports/*.md` 报告。",
    ...
    return (
        "\n".join(
            [
                ...
                "./scripts/aiwiki-launcher.sh advanced shell-status",
                "./scripts/aiwiki-launcher.sh advanced compile",
                './scripts/aiwiki-launcher.sh advanced run-ask-submit "总结今天的关键变化" --format report',
                "./scripts/aiwiki-launcher.sh advanced run-nightly",
                "```",
                "",
