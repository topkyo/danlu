...
| Product Shell | 12% | 9.3 | yes | Jest **174** + sync `run-ask` 单飞 + Today-first |
...
- 2026-07-22（shell less cuts）：去掉 received/soft-hint、死 modal/builder/i18n、vault-queue；Jest **174**。
