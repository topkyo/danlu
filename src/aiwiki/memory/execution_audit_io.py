...
Moved from ``execution.policy`` so memory health can load audit snapshots
without importing the execution package. Best-effort loaders and append
writers remain in ``execution.policy``.
"""
