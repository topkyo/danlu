...
| heavy/light alchemy lane | partial | 已有 `aiwiki alchemy heavy|light <scope> --dry-run` 只读 preview；当前 `nightly / compile / lint / review` primitives 已在，但尚未形成执行调度入口。 |
