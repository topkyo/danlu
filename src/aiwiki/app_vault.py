...
def _render_launcher_script(runtime_root: Path) -> str:
    ...
    return "\n".join(
        [
            ...
            "profiles = {",
            '    "deepseek-api": {"model": "deepseek-v4-pro", "key_setting": "llmDeepseekApiKey", "key_env": "AIWIKI_DEEPSEEK_API_KEY", "base_setting": "llmDeepseekBaseUrl", "base_env": "AIWIKI_DEEPSEEK_BASE_URL"},',
